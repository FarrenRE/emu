...
export default function IQFooterLinks() {
  return (
    <table align="center" border={0} cellPadding={0} cellSpacing={0} width="100%">
      <tbody>
        <tr>
          <td>&nbsp;</td>
          <td width={460} align="center" className="em_white" style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontSize: '12px', lineHeight: '18px', color: '#ffffff', textAlign: 'center' }}>
